LANGUAGE_NAME := tree-sitter-el2
HOMEPAGE_URL := evan-a-w/tree-sitter-el2
VERSION := 0.1.0
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/el2
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/el2
